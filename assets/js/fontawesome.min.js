!function() {
    ...
    function d(n) {
        var t = n.icons, e = t.main, r = t.compose, a = n.prefix, o = n.iconName, s = n.transform, l = n.title, c = n.extra, g = r.found ? r : e, d = g.width, p = g.height, h = "fa-w-" + Math.ceil(d / p * 16), v = [ rn.replacementClass, o ? rn.familyPrefix + "-" + o : "", h ].concat(c.classes).join(" "), b = $({}, c.attributes, {
            "data-prefix": a,
            "data-icon": o,
            class: v,
            role: "img",
    ...
    var gn = {
        ...
        mark: zn,
        measure: zn
    }, Cn = 'FA "5.0.0-beta6"', Nn = function(n) {
    ...
    var $n = function(n) {
        ...
        icon: function(n) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = t.transform, r = void 0 === e ? Mn : e, a = t.compose, o = void 0 === a ? null : a, s = t.title, f = void 0 === s ? null : s, l = t.classes, c = void 0 === l ? [] : l, u = t.attributes, m = void 0 === u ? {} : u, g = t.style, p = void 0 === g ? {} : g, h = n.icon ? n : F(n), v = h.prefix, b = h.iconName, w = h.icon;
            return I($({
                type: "icon"
            }, n), function() {
